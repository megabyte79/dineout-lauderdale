...
@media (prefers-color-scheme: dark){
  :root:where(:not([data-theme="light"])){
    ...
    --inset:#1B2634; --cobalt:#173A6E; --topbar:#0A0E14;
  }
}
...
@media (prefers-color-scheme: dark){:root:where(:not([data-theme="light"])) .topbar{background:#0A0E14}}
...
@media (prefers-color-scheme: dark){:root:where(:not([data-theme="light"])) .tierp{color:var(--sky)}}
...
@media (prefers-color-scheme: dark){:root:where(:not([data-theme="light"])) .tabbtn.active{color:#fff}}
